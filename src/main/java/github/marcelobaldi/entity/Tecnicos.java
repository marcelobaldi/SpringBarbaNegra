...
public class Tecnicos {                                      //Classe            (Acesso e Nome)
    ...
    public Tecnicos() { }
    public Tecnicos(String nome, String email) { this.nome = nome; this.email = email; }
    public Tecnicos(Integer id, String nome, String email) { this.id = id; this.nome = nome; this.email = email; }
    ...
    @Override public String toString() {
        return "Tecnicos {" + "id=" + id + ", nome='" + nome + '\'' + ", email='" + email + '\'' + '}';
    }
}
